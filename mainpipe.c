...
/*   Updated: 2022/12/27 00:40:57 by mmakboub         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int ac, char **av, char **env)
{
	...
	line_cmd0->args[1] = ft_strdup("-lRa");
	...
	handle_pipe(line_cmd0 ,"/bin/ls" , "/usr/bin/grep","/usr/bin/wc",env, line_cmd0->args, line_cmd1->args,line_cmd2->args);
